...
<%  UserDao userDao = new UserDao("digiclass");
    ...
    UserDetailsDao userPersonalDetails = new UserDetailsDao("digiclass");
    UserDetails userDetails = userPersonalDetails.getUserDetailsByUserId(u.getID());
...
<div class="font container">
    <h2 class="text-center mt-3">Weekly Timetable</h2>
