...
public class TwoFactorAuthenticator {
     ...
     * using {@link SecureRandom}. Could be used to generate the QR image to be
     * shared with the user. Other lengths should use
    ...
    /**
     * Similar to {@link #generateBase32Secret()} but specifies a character
     * length.
     */
    ...
    /**
     * Generate and return a 32-character secret key in hexadecimal format
     * (0-9A-F) using {@link SecureRandom}. Could be used to generate the QR
     * image to be shared with the user. Other lengths should use
    ...
    /**
     * Validate a given secret-number using the secret base-32 string. This
     * allows you to set a window in milliseconds to account for people being
     * close to the end of the time-step. For example, if windowMillis is 10000
     * then this method will check the authNumber against the generated number
     * from 10 seconds before now through 10 seconds after now.
     *
     * <p>
     ...
     * @param authNumber Time based number provided by the user from their
     * authenticator application.
     * @param windowMillis Number of milliseconds that they are allowed to be
     * off and still match. This checks before and after the current time to
     * account for clock variance. Set to 0 for no window.
     * @return True if the authNumber matched the calculated number within the
     * specified window.
     */
    ...
    /**
     * Similar to {@link #validateCurrentNumber(String, int, long)} except it
     * uses a hexadecimal secret instead of base-32.
     *
     * @param hexSecret Secret string encoded in hexadecimal that was used to
     * generate the QR code or shared with the user.
     * @param authNumber Time based number provided by the user from their
     * authenticator application.
     * @param windowMillis Number of milliseconds that they are allowed to be
    ...
    /**
     * Similar to {@link #validateCurrentNumber(String, int, int)} except
     * exposes other parameters. Mostly for testing.
     *
     * @param base32Secret Secret string encoded using base-32 that was used to
     * generate the QR code or shared with the user.
     * @param authNumber Time based number provided by the user from their
    ...
    /**
     * Similar to {@link #validateCurrentNumberHex(String, int, int)} except
     * exposes other parameters. Mostly for testing.
     *
     * @param hexSecret Secret string encoded in hexadecimal that was used to
     * generate the QR code or shared with the user.
    ...
    /**
     * Similar to
     * {@link #validateCurrentNumber(String, int, long, long, int, int)} except
     * it uses hexadecimal secret instead of base-32.
     *
     * @param hexSecret Secret string encoded in hexadecimal that was used to
     * generate the QR code or shared with the user.
     * @param authNumber Time based number provided by the user from their
    ...
    /**
     * Return the current number to be checked. This can be compared against
     * user input.
     *
     * <p>
     * WARNING: This requires a system clock that is in sync with the world.
    ...
    /**
     * Similar to {@link #generateCurrentNumberString(String)} except this uses
     * a hexadecimal secret.
     *
     * @param hexSecret Secret string encoded in hexadecimal that was used to
     * generate the QR code or shared with the user.
     * @return A number as a string with possible leading zeros which should
    ...
    /**
     * Similar to {@link #generateCurrentNumberString(String, int)} but you
    ...
    /**
     * Similar to {@link #generateCurrentNumberString(String)} except exposes
    ...
    /**
     * Similar to {@link #generateNumberStringHex(String, long, int, int)}
     * except it uses a hexadecimal secret.
     *
     * @param hexSecret Secret string encoded in hexadecimal that was used to
     * generate the QR code or shared with the user.
     * @param timeMillis Time in milliseconds.
    ...
    /**
     * Similar to {@link #generateCurrentNumberString(String)} but this returns
    ...
    /**
     * Similar to {@link #generateCurrentNumberStringHex(String)} but this
     * returns a int instead of a string.
     *
     * @return A number which should match the user's authenticator application
     * output.
     */
    ...
    /**
     * Similar to {@link #generateCurrentNumberString(String, int)} but this
     * returns a int instead of a string.
     *
     * @return A number which should match the user's authenticator application
     * output.
    ...
    /**
     * Similar to {@link #generateCurrentNumberStringHex(String, int)} but this
     * returns a int instead of a string.
     *
     * @return A number which should match the user's authenticator application
     * output.
    ...
    /**
     * Similar to {@link #generateNumberString(String, long, int, int)} but this
     * returns a int instead of a string.
     *
     * @return A number which should match the user's authenticator application
     * output.
    ...
    /**
     * Similar to {@link #generateNumberStringHex(String, long, int, int))} but
     * this returns a int instead of a string.
     *
     * @return A number which should match the user's authenticator application
     * output.
     */
    ...
    /**
     * Similar to {@link #generateNumberString(String, long, int)} but this
     * returns a int instead of a string.
     *
     * @return A number which should match the user's authenticator application
     * output.
    ...
    /**
     * Similar to {@link #generateNumber(String, long, int, int)} but with a
     * hexadecimal secret.
     *
     * @return A number which should match the user's authenticator application
     * output.
    ...
    /**
     * Return the QR image url thanks to Google. This can be shown to the user
     * and scanned by the authenticator program as an easy way to enter the
     * secret.
     *
     ...
     * @param secret Secret string that will be used when generating the current
     * number.
     * @param numDigits The number of digits of the OTP. Can be set to
     * {@link #DEFAULT_OTP_LENGTH}.
     * @param imageDimension The dimension of the image, width and height. Can
     * be set to {@link #DEFAULT_QR_DIMENTION}.
     */
    ...
    /**
     * Decode base-32 string. I didn't want to add a dependency to Apache Codec
     * just for this decode method. Exposed for testing.
     */
    ...
    /**
     * Decode hexadecimal string method. I didn't want to add a dependency to
     * Apache Codec just for this decode method. Exposed for testing.
     */
